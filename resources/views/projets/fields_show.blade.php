<div class="col-sm-12">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::select('coordonnateur', $coordonnateurs, $projet->coordonnateurs->last()->id ?? null, ['class' => 'form-control', 'id' => 'coordonnateur', 'placeholder' => 'Sélectionner un coordonnateur']) !!}
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-6">
