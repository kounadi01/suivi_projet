...
<div class="card card-primary card-outline mb-12">
    <div class="card-header">
        <div class="card-title">Les différentes évaluation</div>
    </div>
    <div class="card-body">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class='btn-group'>
                    <a href="{{ route('realisations.edit', $realisation->id) }}" class="btn btn-info data-tooltip" data-tooltip="Modifier le projet">
                        <i class="fas fa-edit"></i>
                    </a>
                
                    <a href="#" data-url="{!! route('realisations.delete', $realisation->id) !!}" id="supprimerProj" class="btn btn-danger data-tooltip" data-tooltip="Supprimer le projet">
