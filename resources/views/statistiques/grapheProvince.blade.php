<div id="grapheAff">
    <div class="row">
        <div class="form-group col-md-4">
            <label for="">Choix province</label>
            {!! Form::select('province_id',$provinces,$province_id,['required','class'=>'form-control select2','id'=>'province_id','placeholder'=>'Veuillez choisir une province']) !!}
        </div>
        <div class="form-group col-md-4">
