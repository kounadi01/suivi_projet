<div id="grapheAff">
    <div class="row">
        <div class="form-group col-md-4">
            <label for="">Choix region</label>
            {!! Form::select('region_id',$regions,$region_id,['required','class'=>'form-control select2','id'=>'region_id','placeholder'=>'Veuillez choisir une region']) !!}
          </div>
          <div class="form-group col-md-4">
