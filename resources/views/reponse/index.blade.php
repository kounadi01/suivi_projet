@extends('layouts.app')
@section('titre' , "Liste des reponses" )
@section('breadcrumb')
...
<div class="content">
    <div class="card card-primary">
        ...
        <div class="card-header bg-light">
            ...
            @if(\App\Models\User::authUserProfil()->nom != 'Administrateur')
                @if (\App\Models\Reponse::getStatutPrevision(\App\Models\AnneeExercice::anneeActive()->id,Auth::user()->structure_id))
                <h1 class="row float-right">
                    <a href="{{route('reponses.create')}}" class="btn btn-primary float-right ml-4"> <i class="fa fa-plus-circle"></i> Nouvelle reponse</a>
                </h1>
                @endif
            @endif
        </div>
        <div class="card-body">
            @include('reponse.table')
        </div>
    </div>
</div>
