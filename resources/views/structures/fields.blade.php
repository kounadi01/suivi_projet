<div class="col-sm-12">
  ...
  <div class="required form-group{!! $errors->has('nom_struct') ? 'has-error' : '' !!}">
    ...
    {!! Form::text('nom_struct', null, ['class' => 'form-control', 'placeholder' => 'Dénomination de la structure','id'=>'nom_struct']) !!}
    {!! $errors->first('nom_struct', '<small class="help-block">:message</small>') !!}
  </div>
  <div class="required form-group {!! $errors->has('sigle_struct') ? 'has-error' : '' !!}">
    <label class="control-label" for="sigle_struct">Sigle</label>
    {!! Form::text('sigle_struct', null, ['class' => 'form-control', 'placeholder' => 'Sigle de la structure ','id'=>'sigle_struct']) !!}
    {!! $errors->first('sigle_struct', '<small class="help-block">:message</small>') !!}
  </div>

  <div class="required form-group {!! $errors->has('siege') ? 'has-error' : '' !!}">
    <label class="control-label" for="siege">Siège</label>
    {!! Form::text('siege', null, ['class' => 'form-control', 'placeholder' => 'Siège de la structure ','id'=>'siege']) !!}
  ...
  <div class="row">
    <div class="required form-group {!! $errors->has('type_struct') ? 'has-error' : '' !!} col-md-6">
      ...
      {!! Form::select('type_struct', ['Societé énergétique'=>'Societé énergétique'], 'Societé énergétique', ['class' => 'form-control', 'placeholder' => 'Selectionner','id'=>'type_struct']) !!}
  ...
  <div class="row">
    <div class="required form-group {!! $errors->has('tel_struct') ? 'has-error' : '' !!} col-md-6">
      ...
      {!! Form::text('tel_struct', null, ['class' => 'form-control', 'placeholder' => 'Numero de telephone ','id'=>'tel_struct']) !!}
    ...
    <div class="required form-group {!! $errors->has('email_struct') ? 'has-error' : '' !!} col-md-6">
      ...
      {!! Form::email('email_struct', null, ['class' => 'form-control', 'placeholder' => 'Email ','id'=>'email_struct']) !!}
