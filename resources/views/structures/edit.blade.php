        ...
        <div class="row justify-content-center">
            <div class="col-sm-10">
                ...
                <div class="card card-light">
                    ...
                    @endif
                    <div class="card-header text-center"> Modifier la structure</div>
                    {!! Form::model($structure, ['route' => ['structures.update', $structure->id], 'method' => 'put','class'=>"main-form",'id'=>"regForm"]) !!}
                    {!! csrf_field() !!}
                    <div class="card-body">

                        @include('structures.fields_edit')
                    </div>
