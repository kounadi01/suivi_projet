...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ->subject('Notification de réinitialisation du mot de passe=>(DGESS/MJPEE)')
            ->line('Vous recevez ce courriel car nous avons reçu une demande de réinitialisation du mot de passe de votre compte.')
            ->action('Réinitialiser votre mot de passe', $url)
